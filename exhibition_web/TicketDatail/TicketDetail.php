...
<header class="header">
    ...
    <main>
        <h1 id="ticketDetailText">Ticket Details</h1>
        <div id="ticket-container"></div>
        <button class="button" id="backBtn" onclick="window.location.href='../homepage/homepage.php'">Back to Homepage</button>
    ...
    <script src="TicketDetail.js"></script>
